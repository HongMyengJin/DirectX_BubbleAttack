...
void CSkyBoxMeshComponent::Init(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, float fWidth, float fHeight, float fDepth)
{
	m_nVertices = 36;
	...
	m_pd3dPositionBuffer = ::CreateBufferResource(pd3dDevice, pd3dCommandList, &m_pxmf3Positions[0], sizeof(XMFLOAT3) * m_nVertices, D3D12_HEAP_TYPE_DEFAULT, D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER, &m_pd3dPositionUploadBuffer);
