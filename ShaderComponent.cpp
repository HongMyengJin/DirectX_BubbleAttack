...
void CShaderComponent::PrepareRender(ID3D12GraphicsCommandList* pd3dCommandList)
{
	if (!m_ppd3dPipelineStates.empty()) pd3dCommandList->SetPipelineState(m_ppd3dPipelineStates[m_iCurrentPipelineState].Get());

	UpdateShaderVariables(pd3dCommandList);
}

void CShaderComponent::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera, void* pContext)
{
}

void CShaderComponent::PostRender(ID3D12GraphicsCommandList* pd3dCommandList)
{
}

void CShaderComponent::CreateShader(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, DXGI_FORMAT pdxgiRtvFormats, DXGI_FORMAT dxgiDsvFormat, D3D12_PRIMITIVE_TOPOLOGY_TYPE eprimitiveTopologyType)
{
...
D3D12_BLEND_DESC CShaderComponent::CreateBlendState()
{
...
D3D12_DEPTH_STENCIL_DESC CShaderComponent::CreateDepthStencilState()
{
